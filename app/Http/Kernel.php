...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        'organization.auth' => \App\Http\Middleware\RedirectIfNotOrganization::class,
        'organization.guest' => \App\Http\Middleware\RedirectIfOrganization::class,
        'org.auth' => \App\Http\Middleware\RedirectIfNotOrg::class,
        'org.guest' => \App\Http\Middleware\RedirectIfOrg::class,
        'facilitator.auth' => \App\Http\Middleware\RedirectIfNotFacilitator::class,
