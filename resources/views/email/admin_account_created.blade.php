	                    	...
	                    	<td>
	                    		...
	                    		<div style="width:100%;margin: 10px 0 40px; padding: 0 15px">
									...
									<p style="line-height:1.5; font-size: 14px">
                                        An admin account has been created for you on ExcelProsLMS. Your login credentials are:<br>
                                    ...
                                    <p><a href="https://www.excelpros-test.i.ng/admin">Proceed to ExcelProsLMS</a></p>
