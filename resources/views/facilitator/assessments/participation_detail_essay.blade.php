        ...
        <div class="white-box">
            <div class="row">
                <div class="col-md-12">
                  <div class="btn-wrap">
                      @if($participation->graded == 'no')
                      <a href="{{ route('facilitator.assessment.grade', ['id' => $participation->id]) }}" class="btn btn-primary btn-lg">
                      Grade Exam</a>
                      @else
                ...
                <div class="col-md-12 tasks_wrap">
                    ...
                    <div class="btn-wrap">
                      @if($participation->graded == 'no')
                      <a href="{{ route('facilitator.assessment.grade', ['id' => $participation->id]) }}" class="btn btn-info btn-lg">
                        Grade Exam</a>
                      @else
                      <span class="btn btn-info btn-lg">Has been graded</span>
                      @endif
