...
<div id="wrapper">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown dropdown-usermenu">
                <a href="" class=" dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                  ...
                  <span class="hidden-sm hidden-xs"><i class="fa fa-user-o"></i> {{ Auth::guard('organization')->user()->contact_person }}</span>
                ...
                <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                  ...
                  <li>
                    <a href="{{ route('organization.logout') }}" onclick="event.preventDefault(); document.getElementById('logout_form_top').submit();">
                      <i class="fa fa-power-off"></i>  Logout
                    </a>

                    <form id="logout_form_top" action="{{ route('organization.logout') }}" method="POST" style="display: none;">
                        {{ csrf_field() }}
                    </form>
                  </li>
    ...
    <div class="main-container">
        ...
        @include('organization.includes.sidenav')
