...
/*
@font-face {
    font-family: 'Gaze-Bold';
    src: url({{ storage_path('fonts\Gaze-Bold.ttf') }}) format("truetype"); 
    font-weight: normal;
    font-style: normal;
}
*/
            ...
            <tr>
                <td>
                    <div class="main_section">
                        ...
                        <h1 class="pname">{{ $recipient_name }}</h1>
                        <br>
                    ...
                    <div class="signature_section">
                        ...
                        <div class="signature">
                            <div class="signature_box">
                                <img src="{{ storage_path('images/cecilia-signature.jpg') }}"/>
                            </div>
