...
<div class="sec_content">
  ...
  <div class="page-title-box">
      <h4 class="page-title">Delete facilitator</h4>
        ...
        <div class="row">
            <div class="col-md-12 tasks_wrap">
              <div class="alert alert-danger">
                <p>You are attempting to delete a facilitator. Please note that this action can not be reversed</p>
              </div>

              <form action="{{ route('admin.facilitators.destroy') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      placeholder="Email" value="{{ $facilitator->email }}" readonly /> 
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      placeholder="Phone" value="{{ $facilitator->phone }}" readonly />
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      placeholder="Brief Bio of Facilitator" readonly>{{ $facilitator->brief_bio }}</textarea>
                    </div>
                  </div>
                ...
                <div class="">
                  <button type="submit" class="btn btn-info btn-lg"> Delete Facilitator </button>
