...
<div class="sec_content">
  ...
  <div class="page-title-box">
      <h4 class="page-title">Edit facilitator Password</h4>
      ...
      <div class="white-box">
        <div class="row">
            <div class="col-md-12 tasks_wrap">
              ...
              <form action="{{ route('admin.facilitators.do_activate') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="">
                  <button type="submit" class="btn btn-info btn-lg"> Activate Profile </button>
