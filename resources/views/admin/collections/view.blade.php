...
<div class="sec_content">
  ...
  <div class="page-title-box">
      <h4 class="page-title">{{ $collection->collection_title }}</h4>
      ...
      <div class="white-box">    
        <div class="row">
          <div class="col-md-2 col-sm-3 col-xs-12">
              <div class="btn-wrap">
                <a href="{{ route('admin.questions.create', ['id' => $collection->collection_id]) }}" class="btn btn-info">Add Question</a>
              </div>
          </div>
      ...
      <div class="white-box">
        <div class="row">
            <div class="col-md-12 tasks_wrap">
                ...
                @else
                    <p>There are no quetions to display for this collection</p>
                @endif
