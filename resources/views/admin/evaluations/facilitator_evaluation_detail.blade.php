  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="white-box">
        <div class="row">
          <div class="col-md-12">
              <h3>Course: {{ $training_program->program_name }}</h3>
              <h4>Facilitator: {{ $facilitator->name }}</h4>

              <div class="floating_btn">
                <a href="{{ route('admin.evaluations.export_facilitator_evaluation', ['id' => $training_program->program_id, 'fac_id' => $facilitator->id]) }}">
                  Export Results
                </a>
              </div>
          </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  <div class="edit-btn-wrap">
                                    <div class="edit-btn">
                                      <a href="{{ route('admin.evaluations.participant_facilitator_evaluation', 
