                        ...
                        <div class="col-md-12">
                            <div class="form_wrap">
                                <form id="regiration_form" method="post" action="{{ route('test.submit_test') }}">
                                    ...
                                    <input type="hidden" name="comments" id="exam_comment" value="">
                                ...
                                ?>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            @if($questions[$i]['answer1'] != NULL)
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="{{ $questions[$i]['question_id'] }}" value="1">
                                                    {!! $questions[$i]['answer1']!!}
                                                </label>
                                            </div>
                                            @endif

                                            @if($questions[$i]['answer2'] != NULL)
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="{{ $questions[$i]['question_id'] }}" value="2">
                                                    {!! $questions[$i]['answer2'] !!}
                                                </label>
                                            </div>
                                            @endif

                                            @if($questions[$i]['answer3'] != NULL)
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="{{ $questions[$i]['question_id'] }}" value="3">
                                                    {!! $questions[$i]['answer3'] !!}
                                                </label>
                                            </div>
                                            @endif

                                            @if($questions[$i]['answer4'] != NULL)
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="{{ $questions[$i]['question_id'] }}" value="4">
                                                    {!! $questions[$i]['answer4'] !!}
                                                </label>
                                            </div>
                                            @endif

                                            @if($questions[$i]['answer5'] != NULL)
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="{{ $questions[$i]['question_id'] }}" value="5">
                                                    {!! $questions[$i]['answer5'] !!}
                                                </label>
                                            </div>
                                            @endif
